...
function Trendy() {
  ...
  const fetchCollections = async () => {
    try {
      const response = await fetch(buildApiUrl('/v1/collections?page=1&per_page=6'));
      if (!response.ok) {
        ...
        <section id="modernism" className="trendy-hero">
          <div className="trendy-hero-container">
            ...
            <div className="trendy-hero-content">
              ...
              <Link href={r.collections} className="trendy-button">
                {t.seeCollections}
              </Link>
            </div>
            ...
            <div className="trendy-hero-images">
              ...
              <div className="trendy-image-controls">
                <button onClick={prevImageSlide} className="carousel-btn" disabled={currentImageSlide === 0}>&larr;</button>
                <button onClick={nextImageSlide} className="carousel-btn" disabled={currentImageSlide >= trendImages.length - 1}>&rarr;</button>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="trendy-collections-container">
            <div className="trendy-collections-header">
              ...
              <div className="trendy-collections-controls">
                <Link href={r.collections} className="view-all-btn">
